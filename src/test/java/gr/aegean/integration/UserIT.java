...
class UserIT extends AbstractIntegrationTest {
    ...
    void shouldGetUser() {
        ...
        /*
            It's not possible to say assertThat(actual).isEqualTo(expected); because we can not know the autogenerated
            id by the database so assuming that the user has an id is not best practise. We can compare the rest of the
            fields
         */
